                    ...
                    <div className="card  w-1/2 shadow-2xl ">
                        <div className="card-body">
                            <fieldset className="fieldset">
                                ...
                                <input type="string" className="input w-3/4" placeholder="Skipper Mark" value={fullName} onChange={(e) => {
                                ...
                                <div><Link className="link link-hover" to={"/login"}>Already have an account? Login?</Link></div>
                                <button className="btn btn-neutral mt-5 font-semibold" onClick={handleSignup}>Create an Account</button>
                            </fieldset>
                        </div>
                    </div>
                </div>
